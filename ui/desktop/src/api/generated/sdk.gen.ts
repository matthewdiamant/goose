...
import type { ReadAllConfigData, ReadAllConfigResponse, RemoveExtensionData, RemoveExtensionResponse, AddExtensionData, AddExtensionResponse, GetConfigPathData, GetConfigPathResponse, ReadConfigData, RemoveConfigData, RemoveConfigResponse, UpsertConfigData, UpsertConfigResponse } from './types.gen';
...
export const getConfigPath = <ThrowOnError extends boolean = false>(options?: Options<GetConfigPathData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetConfigPathResponse, unknown, ThrowOnError>({
        url: '/config/path',
        ...options
    });
};
